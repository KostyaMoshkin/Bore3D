...
// Bore3Dtest.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CBore3DtestApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CBore3DtestApp

CBore3DtestApp::CBore3DtestApp()
{
...
// Единственный объект CBore3DtestApp

CBore3DtestApp theApp;


// Инициализация CBore3DtestApp

BOOL CBore3DtestApp::InitInstance()
{
